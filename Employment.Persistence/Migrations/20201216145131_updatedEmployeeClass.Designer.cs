...
namespace Employment.Persistence.Migrations
{
    ...
    [Migration("20201216145131_updatedEmployeeClass")]
    partial class updatedEmployeeClass
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Employment.Entity.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Employment.Entity.PaymentRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Employment.Entity.TaxYear", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Employment.Entity.PaymentRecord", b =>
                {
                    b.HasOne("Employment.Entity.Employee", "Employee")
                        .WithMany("PaymentRecord")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Employment.Entity.TaxYear", "TaxYear")
                        .WithMany()
