	...
	public class EmployeeController : Controller
	{
		...
		public async Task<IActionResult> Create(EmployeeCreateViewModel model)
		{
			if (ModelState.IsValid)
			{
				...
				if(model.ImageUrl != null && model.ImageUrl.Length > 0)
				{
					...
					var webRootPath = _webEnvironment.WebRootPath;
		...
		public async Task<IActionResult> Edit(EmployeeEditViewModel model)
		{
			if (ModelState.IsValid)
			{
				...
				employee.FirstName = /*firstName =*/ model.FirstName;
				employee.LastName = /*lastName =*/ model.LastName;
				employee.MiddleName =/*= middleName = */model.MiddleName;
				employee.FullName = model.FullName;
				//employee.FullName = _employeeService.GetFullName(firstName, lastName, middleName);
